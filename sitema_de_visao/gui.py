...
class GUI:
    ...
    def __init__(self, window_title, video_source=0):
        ...
        ''' Misc '''
        self.name_text_box = Entry(self.window, textvariable=self.name)
        self.btn_save = Button(self.window, text='Salvar Máscara', command=self.save)
        self.btn_rst = Button(self.window, text='Resetar Máscara', command=self.rst)
        self.btn_calb = Button(self.window, text='Calibrar Origem', command=self.calibrate)
